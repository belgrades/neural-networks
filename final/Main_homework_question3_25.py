from final.Functions_homework1_question3_25 import generate_train_test, generate_decomposition_variables
from final.Functions_homework1_question3_25 import generate_decomposition_y_hat_function, generate_generic_loss_functions
from final.Functions_homework1_question3_25 import generate_decomposition_optimizers
from final.Functions_homework1_question3_25 import init_tf_session, train_decomposition_model
from final.Functions_homework1_question3_25 import predict_decomposition, generate_mse_functions, compute_mse, compute_loss
from final.Functions_homework1_question3_25 import plot_pred_real, plot_3d_data
from final.Functions_homework1_question3_25 import generate_decomposition_variables
import numpy as np
...
def exercise_3_1(output_file):
    ...
    HIDDEN_UNITS = 20  # Number of hidden nodes
