from Functions_homework1_question2_25 import generate_train_test, generate_extreme_mlp_variables
from Functions_homework1_question2_25 import generate_mlp_y_hat_function, generate_generic_loss_functions
from Functions_homework1_question2_25 import generate_generic_optimizer
from Functions_homework1_question2_25 import init_tf_session, train_generic_model
from Functions_homework1_question2_25 import predict_mlp, generate_mse_functions, compute_mse, compute_loss
from Functions_homework1_question2_25 import plot_pred_real, plot_3d_data
from Functions_homework1_question2_25 import generate_unsupervised_rbf_variables, generate_unsupervised_rbf_y_hat_function
import numpy as np
...
def exercise_2_1(output_file):
    ...
    print("Training objective function,%0.3f"%(training_loss_value[0]))
    output_file.write("Training objective function,%0.3f\n"%(training_loss_value[0]))
    ...
    if GENERATE_IMAGES:
        ...
        plot_3d_data(test_X, y_pred_plot, title="Approximation of franke2d(x1, x2) with extreme learning MLP")
...
def exercise_2_2(output_file):
    ...
    if GENERATE_IMAGES:
        ...
        plot_3d_data(test_X, test_y)
        plot_3d_data(test_X, y_pred_plot, title="Approximation of Franke2d(x1,x2) function with Kmeans RBF")
